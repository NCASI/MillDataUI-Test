    ...
    public partial class MillDataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<HistoricalMillInfo>(entity =>
            {
                ...
                entity.Property(e => e.FkMillId).HasColumnName("FK_MillID");

                entity.Property(e => e.WhatChanged).HasColumnType("varchar(max)");

                entity.HasOne(d => d.FkMill)
                    .WithMany(p => p.HistoricalMillInfo)
                    .HasForeignKey(d => d.FkMillId)
            ...
            modelBuilder.Entity<MillCodeLinks>(entity =>
            {
                ...
                entity.Property(e => e.Nims).HasColumnName("NIMS");
            });

            modelBuilder.Entity<MillCodischarger>(entity =>
            {
                entity.HasKey(e => e.CodischargeId)
                    .HasName("PK_MillCoDischarger");

                entity.Property(e => e.CodischargeId).HasColumnName("CodischargeID");

                entity.HasOne(d => d.MillKey1Navigation)
                    .WithMany(p => p.MillCodischargerMillKey1Navigation)
                    .HasForeignKey(d => d.MillKey1)
                    .HasConstraintName("FK_MillCodischarger_MillInformation");

                entity.HasOne(d => d.MillKey2Navigation)
                    .WithMany(p => p.MillCodischargerMillKey2Navigation)
                    .HasForeignKey(d => d.MillKey2)
            ...
            {
                entity.HasKey(e => e.NarrativeId)
                    .HasName("PK_MillNarrative");

                entity.Property(e => e.NarrativeId).HasColumnName("NarrativeID");
            ...
            {
                entity.HasKey(e => e.MillSicid)
                    .HasName("PK_MillSICCodes_1");

                entity.ToTable("MillSICCodes");

                entity.Property(e => e.MillSicid).HasColumnName("MillSICID");
            ...
            modelBuilder.Entity<Npdesdocs>(entity =>
            {
                ...
                entity.Property(e => e.FkNpdesid).HasColumnName("FK_NPDESID");
                ...
                entity.HasOne(d => d.FkNpdes)
                    .WithMany(p => p.Npdesdocs)
                    .HasForeignKey(d => d.FkNpdesid)
            ...
            {
                entity.HasKey(e => e.SludgeId)
                    .HasName("PK_SludgeData");

                entity.Property(e => e.SludgeId).HasColumnName("SludgeID");
            ...
            {
                entity.HasKey(e => e.WaterTreatmentId)
                    .HasName("PK_WaterTreatmentData");

                entity.Property(e => e.WaterTreatmentId).HasColumnName("WaterTreatmentID");
