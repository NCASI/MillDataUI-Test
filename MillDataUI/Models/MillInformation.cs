...
namespace MillDataUI.Models
{
    public partial class MillInformation
    {
        public MillInformation()
        {
            ...
            MillCodischargerMillKey1Navigation = new HashSet<MillCodischarger>();
            MillCodischargerMillKey2Navigation = new HashSet<MillCodischarger>();
        ...
        public virtual ICollection<MillCodischarger> MillCodischargerMillKey1Navigation { get; set; }
        public virtual ICollection<MillCodischarger> MillCodischargerMillKey2Navigation { get; set; }
